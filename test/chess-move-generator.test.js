...
*/
var DEPTH, LOG, bitBoardClass, chessMoveGenerator, compareArrays, getInitialCounterArray, positionClass, testDepth, trimString;
    ...
    for (_i = 0, _len = testVector.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        ...
        for (expectedMove in expectedData) {
          ...
          _results2.push(assert.eql(calculatedQuantity, expectedQuantity, "Unexpected quantity for move " + expectedMove + " from position " + positionString + ": " + calculatedQuantity));
        }
        return _results2;
      })());
    }
