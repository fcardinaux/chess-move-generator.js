...
module.exports.generateJavascriptLines = function(bitBoardDataPrefix, positionDataPrefix, headerLine) {
  var lines, moves, quadrant, sep, shadows, square, squareInQuadrant, valueInQuadrant;
  ...
  for (quadrant = 0; quadrant <= 3; quadrant++) {
    for (squareInQuadrant = 0; squareInQuadrant <= 15; squareInQuadrant++) {
...
loadPawnNonTakingMoves = function(color) {
  var iCol, iRow, ordinaryMoveArr, out, row2MoveArr, row7MoveArr;
...
loadPawnTakingMoves = function(color) {
  var iCol, iRow, out, takingMoveArr;
